...
def beacon_kingfisher():
    ...
    try:
        try:
            ...
            # not a users msg - register or something else
        ...
        for user_data in users:
            ...
            if username in existing_users:
                ...
                # Note: 'username' and 'account_type' are usually static
                ...
                new_user = SystemUser(
                    agent_id=agent_id,
                    username=username, # Ensure 'username' column exists in your Model
